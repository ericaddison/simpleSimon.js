/* Add an "annulus()" function to the CanvasRenderingContext2D
* prototype, used to draw a section of a circular annulus.
* Works similar to built-in arc() or lineTo() functions.
* Just creates an appropriate closed path, relies on the
* user to call ctx.fill() or ctx.stroke() to draw.
*/
